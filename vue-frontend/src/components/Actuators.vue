      ...
      >
        <div v-if="actuator === 'servo'">
          ...
          <div>
            <b-form-input
              id="range-1"
              v-model="actuator_values[actuator][instance]"
              type="range"
              min="0"
              max="180"
              @change="sendData(actuator, instance)"
            />
          </div>
        </div>
        ...
        <div v-if="actuator === 'oled'">
          <div class="row">
            ...
            <div class="col-5">
              <b-form-select
                v-model="actuator_values[actuator][instance].type"
                :options="oled_options"
              />
            </div>
            <div class="col-5">
              <b-form-input
                v-model="actuator_values[actuator][instance].value"
                placeholder=""
                @change="set_oled(actuator, instance)"
              />
            </div>
          </div>
        </div>
